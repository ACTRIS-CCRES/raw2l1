...
class TestRunWLS71S(unittest.TestCase):
    ...
    def test_leosphere_wls7_102(self):
        ...
        test_ofile = os.path.join(
            TEST_OUT_DIR,
            'Wls7-1s-10-v1.0.2.nc')
        test_cfile = os.path.join(
            CONF_DIR,
            'conf_leosphere_wls7_1s.ini')
