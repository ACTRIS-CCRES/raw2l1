...
class TestChm15kMetOffice(unittest.TestCase):
    ...
    conf_file = os.path.join(CONF_DIR, 'conf_lufft_chm15k-nimbus-uk-metoffice_eprofile.ini')
    ...
    def test_20160514(self):
        ...
        test_ofile = os.path.join(
            TEST_OUT_DIR,
            'test_chm15k_metoffice.nc')
        test_cfile = os.path.join(
            CONF_DIR,
            'conf_lufft_chm15k-nimbus-uk-metoffice_eprofile.ini')
