...
@pytest.mark.parametrize(
    "date, conf_dir, conf_file, instr_dir_chm15k, input_file, chm15k_output_dir, tmp_dir, firmware",
    [
        (
            "20120306",
            "conf_dir",
...
def test_conversion(
    ...
    conf_file = open(conf_dir / conf_file)
    input_file = str(instr_dir_chm15k / input_file)
    output_file = str(chm15k_output_dir / input_file)
